...
'%(nrows)s records found': '%(nrows)s 翻譯records found',
...
'Design for': '設計為了',
'Device': '翻譯Device',
'Device History': '翻譯Device History',
'Device Type': '翻譯Device Type',
'DISK': 'DISK',
...
'Logout': '登出',
'Look up': '翻譯Look up',
'Look up device connectivity': '翻譯Look up device connectivity',
'Lost Password': '密碼遺忘',
'Lost password?': '密碼遺忘?',
'Main Menu': '主選單',
'Make': '翻譯Make',
...
'Mandarin': '中文',
'Master': '主',
'Medical Device': '翻譯Medical Device',
'medical device database': '醫療儀器資料庫',
'Medical Device History': '醫療設備歷史',
'Medical Device History Transcript': '醫療器械歷史成績單',
'Medical Site': '翻譯Medical Site',
...
'Profile': 'Profile',
'Proton Therapy': '翻譯Proton Therapy',
'Python': 'Python',
'Query:': '查詢:',
'Quick Examples': 'Quick Examples',
'Radiotherapy': '翻譯Radiotherapy',
'RAM': 'RAM',
'RAM Cache Keys': 'RAM Cache Keys',
'Ram Cleared': 'Ram Cleared',
'Received at': '翻譯Received at',
'Received At': '翻譯Received At',
'Recipes': 'Recipes',
'Record': '紀錄',
...
'Register': '註冊',
'register': '註冊',
'Register new device': '翻譯Register new device',
'Register new event': '翻譯Register new event',
'Register new site': '翻譯Register new site',
